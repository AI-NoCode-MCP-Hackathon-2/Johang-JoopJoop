...
### 수정 내용
- **components/Hero.tsx** (line 53)
  - 1차 변경: `leading-[1.8]` → `leading-[2.0]`
  - 2차 변경 (추가 조정): `leading-[2.0]` → `leading-[2.4]`
  - 제목: "사인하기 전에, 함정 조항부터 먼저 찾아드립니다."

### 개선 효과
- 줄 간격이 최종적으로 33% 증가 (1.8 → 2.4)
- 글자 겹침 현상 완전 해결
- 모든 화면 크기에서 충분한 여백 확보
- 더 여유로운 타이포그래피로 전문적이고 가독성 높은 디자인
